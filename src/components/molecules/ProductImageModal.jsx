        ...
        <div className="flex items-center justify-between p-3 sm:p-4 md:p-6 border-b border-white/10 flex-shrink-0">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-sm sm:text-base md:text-xl font-bold text-white truncate">{product.name}</h2>
              <p className="text-xs sm:text-sm text-white/70 truncate">{product.category}</p>
            </div>
          </div>
