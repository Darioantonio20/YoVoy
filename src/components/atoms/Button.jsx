...
const Button = memo(({ children, variant = "primary", className = "", disabled = false, ...props }) => {
  ...
  const variants = {
    ...
    glass: "bg-white/10 backdrop-blur-md border border-white/20 text-white shadow-lg hover:bg-white/20 hover:border-white/30 focus:ring-white/30",
    ...
    minimal: "bg-transparent border border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400 focus:ring-gray-400",
    ...
    elegant: "bg-gradient-to-r from-slate-600 to-slate-700 text-white shadow-lg hover:from-slate-700 hover:to-slate-800 focus:ring-slate-500 rounded-full px-8",
    ...
    liquid: "relative overflow-hidden bg-gradient-to-br from-black/20 via-gray-800/20 to-white/10 backdrop-blur-xl border border-white/30 text-white shadow-[0_8px_32px_rgba(255,255,255,0.2)] hover:shadow-[0_8px_32px_rgba(255,255,255,0.4)] focus:ring-gray-400 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:translate-x-[-100%] hover:before:translate-x-[100%] before:transition-transform before:duration-1000 before:ease-out after:absolute after:inset-0 after:bg-gradient-to-br after:from-white/20 after:via-gray-300/20 after:to-black/20 after:opacity-0 hover:after:opacity-100 after:transition-opacity after:duration-300 after:animate-pulse"
  };
