...
const BackgroundDecorator = () => {
  return (
    <div className='absolute inset-0 overflow-hidden'>
      {/* Círculos flotantes */}
      <div className='absolute top-20 left-10 w-32 h-32 bg-[#F9C81E]/10 rounded-full blur-xl animate-pulse'></div>
      ...
      {/* Líneas decorativas */}
      <div className='absolute top-1/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#F9C81E]/20 to-transparent'></div>
